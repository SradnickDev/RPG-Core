...
namespace RPGCore.Items
{
	public static class ItemUtilities
	{
		...
		public static string Name(this ItemTemplate template)
		{
			var itemType = template.GetType().Name;
			return itemType.Remove(itemType.Length - "ItemTemplate".Length, "ItemTemplate".Length);
		}
		
		public static bool TryGetTargetSlot(PointerEventData eventData, out ItemSlot targetSlot)
		{
			var element = eventData.pointerEnter;
			targetSlot = element != null ? element.GetComponent<ItemSlot>() : null;
